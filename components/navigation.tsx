      ...
      >
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div 
              className="flex items-center gap-2 text-xl font-bold gradient-text cursor-pointer group transition-all duration-300 hover:scale-105" 
              onClick={() => handleNavClick("#inicio")}
            >
              <div className="w-8 h-8 rounded-lg bg-accent/20 flex items-center justify-center group-hover:bg-accent/30 transition-colors duration-300">
